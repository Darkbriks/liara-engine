...
namespace Liara::Graphics::Ubo
{
    ...
    struct alignas(Constants::UNIFORM_BUFFER_ALIGNMENT) GlobalUbo
    {
        ...
        glm::vec4 directionalLightDirection =
            glm::vec4(glm::normalize(glm::vec3(1.0f, -3.0f, -1.0f)),
                      0.0f);  ///< The direction of the directional light, w is ignored
        glm::vec4 directionalLightColor{
            1.f, 1.f, 1.f, .01f};  ///< The color of the directional light, w represents the intensity of the light
