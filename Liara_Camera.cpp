...
namespace Liara
{
    void Liara_Camera::SetOrthographicProjection(const float left, const float right, const float top, const float bottom, const float near, const float far)
    {
    ...
    void Liara_Camera::SetViewDirection(const glm::vec3 &position, const glm::vec3 &direction, const glm::vec3 &up)
    {
    ...
    void Liara_Camera::SetViewYXZ(const glm::vec3& position, const glm::vec3& rotation)
    {
