...
function(liara_detect_modules_support)
    ...
    elseif (CMAKE_CXX_COMPILER_ID STREQUAL "Clang")
        if (CMAKE_CXX_COMPILER_VERSION VERSION_LESS "20.0")
            message(STATUS "Clang ${CMAKE_CXX_COMPILER_VERSION} detected - modules support for this project requires at least Clang 20.0")
            message(STATUS "Falling back to header-only mode")
        else()
            set(LIARA_MODULES_SUPPORTED ON)
    ...
    elseif (CMAKE_CXX_COMPILER_ID STREQUAL "GNU")
        if (CMAKE_CXX_COMPILER_VERSION VERSION_LESS "13.0")
            message(STATUS "GCC ${CMAKE_CXX_COMPILER_VERSION} detected - modules support for this project requires at least GCC 14.0")
            message(STATUS "Falling back to header-only mode")
